...
class Scut(torch.nn.Module):
    # def __init__(self, output_size, hidden_size, layers, channels, embedding_size):
    def __init__(self, output_size=7, hidden_size=64, layers=4, channels=2, embedding_size=4096):
        super().__init__()
...
if __name__ == "__main__":
    model = Net4CNN(output_size=10, hidden_size=64, layers=4, channels=2, embedding_size=4096)
